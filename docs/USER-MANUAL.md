...
Ang guide na ito ay para sa kasalukuyang stable release (v1.0.13), na may
inventory expiration tracking, mas malinaw na X-Read/Z-Read reports, at
karagdagang utang checkout reminders.
...
**TINDA POS v1.0.13** - Official release page: <https://github.com/Yazerukun/TINDA-POS/releases/tag/v1.0.13>

Files for this release:

- `TindaPOS-Setup-1.0.13.exe` — Windows installer
- `TindaPOS-Portable-1.0.13.exe` — no-install portable edition
