...
<img src="https://img.shields.io/badge/TINDA_POS-v1.0.22-059669?style=for-the-badge&labelColor=065f46" alt="Version">
...
[⬇️ Download v1.0.22 Setup](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-Setup-1.0.22.exe)&nbsp;&nbsp;·&nbsp;&nbsp;[📦 Portable Edition](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-Portable-1.0.22.exe)&nbsp;&nbsp;·&nbsp;&nbsp;[📄 User Guide PDF](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-User-Guide.pdf)&nbsp;&nbsp;·&nbsp;&nbsp;[🐛 Report Issue](https://github.com/Yazerukun/TINDA-POS/issues)
...
> **Utang English Standardization & Strict Responsive Table Alignment** — clean English interface for customer credit and auto-adjusting table column alignment across all laptop and desktop monitors.

- 🌐 **English Standardization in Utang** — all credit interface labels, tabs, badges, and empty states now use standard English: **With Balance** (active debts), **Settled** (₱0.00 accounts), and **All** (all accounts) with live counter badges.
- 📐 **Strict Column Alignment (Utang & Transactions)** — explicit column widths and matching header/cell padding ensure numbers line up with precision. Switching tabs or expanding rows no longer shifts or jumps columns.
- 📱 **Responsive Table Auto-Adjustment** — added `overflow-x-auto` to both Utang and Transactions tables, allowing them to automatically adapt across all laptop (1366×768, 1280×800) and desktop screens without squishing or clipping.
- 🧾 **Transactions Expanded Items `<tfoot>`** — expanded transaction items now use a dedicated footer where **Subtotal**, **Discount**, and **Total** are strictly aligned directly under the Subtotal column.
...
|---|---|:---:|
| **TINDA POS Setup (Installer)** | ✅ **Recommended.** Installs TINDA POS with automatic desktop shortcut and background auto-update support. | [⬇️ Download Setup](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-Setup-1.0.22.exe) |
| **TINDA POS Portable** | Standalone version. Runs directly from a USB drive or folder without installation. Stores database beside the EXE. | [📦 Download Portable](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-Portable-1.0.22.exe) |
| **Official User Guide (PDF)** | Comprehensive 26-page printable step-by-step user guide with screenshots, workflows, and troubleshooting. | [📄 Download PDF Guide](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-User-Guide.pdf) |
| **Release Checksum Manifest** | SHA256 checksums to verify file integrity. | [🛡️ View SHA256SUMS](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/SHA256SUMS-v1.0.22.txt) |
...
1. **Install:** Run `TindaPOS-Setup-1.0.22.exe` and launch the application.
...
> 💡 **Seamless Upgrade:** Users on **v1.0.19**, **v1.0.20**, and **v1.0.21** will automatically detect and upgrade to **v1.0.22** with zero data loss or manual re-configuration.
...
**[⬇️ Download v1.0.22 Setup](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-Setup-1.0.22.exe)** · **[📄 User Guide PDF](https://github.com/Yazerukun/TINDA-POS/releases/download/v1.0.22/TindaPOS-User-Guide.pdf)** · **[💬 Community Issues](https://github.com/Yazerukun/TINDA-POS/issues)**
