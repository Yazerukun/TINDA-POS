...
## v1.0.3 IN-APP UPDATE SYSTEM (Phase 23 — 2026-09-06) — IMPLEMENTED, NOT RELEASED
...
> production build PASS · `docs:pdf` 11 pages / 94,370 B / version 1.0.3. **DO NOT
> publish/tag/release v1.0.3 until reviewed.**
...
### Windows artifacts (built, NOT published)
